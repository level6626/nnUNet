...
from nnunet.training.loss_functions.dice_loss import DC_CE_BIoU_loss
...
class nnUNetTrainerV2_BIoU(nnUNetTrainerV2):
    """
    ...
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        self.loss = DC_CE_BIoU_loss({'batch_dice': self.batch_dice, 'smooth': 1e-5, 'do_bg': False}, {})
