...
import numpy as np
import torch
from nnunet.training.network_training.nnUNetTrainerV2_boundary import nnUNetTrainerV2_boundary
...
class nnUNetTrainerV2_boundary_cavity(nnUNetTrainerV2_boundary):
    """
    ...
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        ## boundary loss
        self.loss = DC_CE_Boundary_loss({'batch_dice': self.batch_dice, 'smooth': 1e-5, 'do_bg': False}, {}, weight_sl=0.025)
        ## change max_num epochs to 500 for cavity
        ## change max_num_epochs to 200 for scar
        self.max_num_epochs = 130
